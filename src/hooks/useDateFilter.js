...
export function useDateFilter() {
	...
	const handleStartDateChange = useCallback(() => {
		...
		if (endDateRef.current) {
			...
			if (moment(endDateRef.current.value).format('YYYY-MM-DD') < moment(minDate).format('YYYY-MM-DD')) {
	...
	const applyDateFilter = useCallback((onChange) => {
	...
	const getFilterByDateFields = useCallback((onChange) => {
